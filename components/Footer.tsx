  ...
  return (
    <footer className="w-screen text-gray-600 dark:text-gray-400/50 font-inter mb-14 print:hidden">
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-4xl gap-5 p-5 mx-auto text-sm border-t-2 border-gray-200 2xl:max-w-5xl 3xl:max-w-7xl dark:border-gray-400/10 sm:text-base"
      >
        {/* <div>
        ...
        <section className="flex flex-col sm:flex-row justify-between align-middle items-center">
          ...
          <div className="flex gap-4 capitalize">
            {supportOptions.map((platform, index) => {
              ...
              return (
                ...
                >
                  <motion.p
                    className="flex items-center justify-center gap-4 p-4 origin-center transform sm:justify-start md:origin-top group"
                    variants={popUp}
                  >
