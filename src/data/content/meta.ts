...
const pageMeta: PageMeta = {
  home: {
    title: '',
    description: `Hey, I am ${name}. A Front-end Developer/React Developer from India who loves to design and code. I use React.js or Next.js to build the web application interfaces and the functionalities. At the moment, I am pursuing my Bachelor's degree in Computer Science.`,
    image,
  ...
  bookmark: {
    ...
    description: `Bookmarked Blogs of ${name}'s blogs by you`,
  ...
  privacy: {
    ...
    description: 'Privacy is an important factor for everyone.',
